...
const ro: LegalDoc = {
  kicker: "Documente juridice",
  title: "Termeni și condiții",
  updated: "Ultima actualizare: 23 septembrie 2026",
  tocLabel: "Cuprins",
  intro: [
    "Acești termeni și condiții („Termenii”) reglementează accesul la https://www.algorithmnode.site și la platforma AlgorithmNode (împreună, „Serviciul”). Prin consultarea site-ului, trimiterea formularului de contact, autentificare sau folosirea tabloului de bord, acceptați Termenii fără rezervă.",
    "Dacă nu acceptați Termenii, trebuie să încetați imediat utilizarea Serviciului. Termenii formează un contract la distanță în sensul dreptului Uniunii Europene și se aplică oricărei persoane fizice sau juridice, profesionist sau consumator, fără a aduce atingere protecțiilor imperative ale consumatorilor.",
    "AlgorithmNode poate modifica Termenii. Versiunea aplicabilă este cea publicată la data utilizării. Continuarea folosirii după publicare înseamnă acceptarea noii versiuni.",
  ],
  sections: [
    {
      title: "1. Operator și natură contractului",
      paragraphs: [
        "Serviciul este editat și operat de AlgorithmNode, operatorul domeniului algorithmnode.site („AlgorithmNode”, „noi”). Corespondența juridică, cererile privind datele personale și reclamațiile se trimit prin formularul de contact de pe site.",
        "Termenii reprezintă întregul acord privind utilizarea Serviciului, sub rezerva Politicii de confidențialitate, a eventualelor condiții speciale comunicate la emiterea unui cont și a regulilor piețelor terțe de execuție.",
      ],
    },
    {
      title: "2. Definiții",
      paragraphs: ["În sensul prezentelor:"],
      list: [
        "„Utilizator”: orice persoană care accesează site-ul sau Serviciul.",
        "„Cont”: spațiu de autentificare emis exclusiv de administratorul AlgorithmNode.",
        "„Agenți”: module software care citesc continuu date de piață.",
        "„Boți”: module de execuție care deschid, ajustează sau închid poziții conform semnalelor și Limitelor.",
        "„Limite”: stop-loss, valoare maximă per tranzacție, expunere zilnică și orice alt parametru de risc setat de Utilizator sau administrator.",
        "„Piețe/Places”: venue-uri sau intermediari conectați, inclusiv Binance, XTB și Plus500, și orice loc de execuție integrat ulterior.",
        "„Date de piață”: cotații, indici, știri și date de referință afișate cu titlu informativ.",
      ],
    },
    {
      title: "3. Descrierea Serviciului",
      paragraphs: [
        "AlgorithmNode furnizează tehnologie de execuție algoritmică. În funcție de Cont, Serviciul poate afișa informații de piață, istoric, setarea Limitelor și, dacă este activat, execuție automată prin Agenți și Boți pe Piețele conectate.",
        "AlgorithmNode nu este instituție de credit, nu este firmă de investiții în sensul MiFID II, nu este consultant de investiții, nu este administrator de portofoliu discreționar și nu este custode. Nimic de pe site — inclusiv istoricul public, variațiile ilustrative sau prețurile live — nu constituie sfat, recomandare personalizată, ofertă publică de valori mobiliare sau garanție de performanță.",
        "Performanțele anterioare, inclusiv orice calendar public, au valoare ilustrativă și nu prefigurează rezultate viitoare. Intervalele de variație indicate nu sunt obiective contractuale.",
      ],
    },
    {
      title: "4. Acces, eligibilitate și conturi",
      paragraphs: [
        "Site-ul public nu necesită cont. Tabloul de bord și funcțiile de execuție sunt disponibile doar după emiterea unui Cont de către administrator. Nu există înregistrare publică self-service.",
        "Declarați că aveți cel puțin 18 ani, capacitate de exercițiu și nu sunteți interzis de a tranzacționa piețele relevante. Nu folosiți Serviciul dacă este ilegal în țara de reședință sau conform sancțiunilor aplicabile.",
        "Sunteți responsabil pentru exactitatea datelor furnizate. Credențialele sunt personale. Acțiunile din Cont se consideră ale dumneavoastră, exceptând notificarea promptă a unei compromiteri.",
      ],
    },
    {
      title: "5. Absența custodiei și Piețe terțe",
      paragraphs: [
        "Cu excepția unei stipulații scrise specifice Contului, AlgorithmNode nu are vocația de a deține fondurile sau instrumentele dumneavoastră în custodie. Execuția se poate realiza pe Piețe terțe. Relația cu acele Piețe (KYC/AML, depozite, marjă, lichidări, program, comisioane de piață) este guvernată de condițiile lor.",
        "AlgorithmNode nu răspunde pentru indisponibilități, întârzieri, respingeri, apeluri de marjă, suspendări de piață sau decizii ale Piețelor. Un ordin lansat de un Bot poate fi modificat, executat parțial sau respins de Piață.",
      ],
    },
    {
      title: "6. Execuție algoritmică, Limite și decizii automatizate",
      paragraphs: [
        "Când Contul o permite, Agenții analizează fluxul de piață, iar Boții pot trimite ordine fără intervenție umană la fiecare tick. Acesta este un prelucrare automatizată care poate afecta semnificativ expunerea. Folosind Serviciul, acceptați expres această prelucrare, păstrând posibilitatea de a seta, modifica sau înăspri Limitele în tabloul de bord, dacă funcția este deschisă Contului.",
        "Ordinele nu sunt destinate să fie trimise în afara Limitelor configurate. Sunteți singurul responsabil că acele Limite corespund situației patrimoniale, apetitului de risc și legii aplicabile. Un stop-loss nu garantează execuția la nivelul cerut în caz de gap, ilichiditate sau defecțiune a Pieței.",
        "AlgorithmNode poate suspenda execuția, refuza un parametru sau impune Limite mai stricte din motive de securitate, conformitate sau stabilitate, fără despăgubire.",
      ],
    },
    {
      title: "7. Depuneri, retrageri și termene",
      paragraphs: [
        "Când mișcările de fonduri apar în tabloul de bord, ele urmează mecanica comunicată pentru Contul dumneavoastră. Retragerile, când sunt disponibile, sunt descrise ca procesate în maximum douăzeci și patru (24) de ore, exceptând sărbătorile, incidentele bancare, controalele de conformitate sau întârzierile unui prestator de plăți ori ale unei Piețe.",
        "AlgorithmNode poate reține, bloca sau refuza o mișcare în caz de suspiciune de fraudă, spălare de bani, neconcordanță de identitate, ordin al unei autorități sau risc operațional. Nu se datorează dobândă pe soldurile afișate.",
      ],
    },
    {
      title: "8. Riscuri",
      paragraphs: [
        "Tranzacționarea instrumentelor financiare, crypto-activelor, mărfurilor, valutelor și derivatelor implică un risc substanțial de pierdere, până la întregul capital angajat și, în funcție de produs și Piață, dincolo de acesta în caz de levier. Pierderile pot apărea mai rapid decât câștigurile.",
        "Confirmați că înțelegeți riscurile, veți angaja doar sume a căror pierdere nu afectează nevoile esențiale și nu tratați site-ul ca pe un sfat. AlgorithmNode nu garantează profit, conservarea capitalului sau continuitatea neîntreruptă a Serviciului.",
      ],
    },
    {
      title: "9. Obligațiile Utilizatorului",
      paragraphs: ["Vă angajați să:"],
      list: [
        "folosiți Serviciul conform legii aplicabile, inclusiv piețe financiare, sancțiuni și AML/CFT;",
        "nu ocoliți Limitele, controalele de acces, autentificarea sau măsurile de securitate;",
        "nu introduceți malware, boți ostili, scraping abuziv, atacuri de tip denial of service sau inginerie inversă neautorizată;",
        "nu uzurpați identitatea unui terț și nu cesionați Contul fără acord scris;",
        "furnizați informații sincere în formularul de contact și în Cont;",
        "monitorizați expunerea și notificările când tabloul de bord este activ.",
      ],
    },
    {
      title: "10. Proprietate intelectuală",
      paragraphs: [
        "Site-ul, marca AlgorithmNode, logo-urile, textele, grafica, arhitectura software, Agenții, Boții, bazele de date și elementele vizuale sunt protejate prin drept de autor, mărci și dreptul sui generis asupra bazelor de date. Reproducerea, extragerea masivă sau adaptarea neautorizată sunt interzise.",
        "Binance, XTB, Plus500 și identificatorii de instrumente rămân proprietatea titularilor. Datele de preț ale terților rămân supuse licențelor lor.",
      ],
    },
    {
      title: "11. Date de piață și conținut informativ",
      paragraphs: [
        "Prețurile live, ticker-ul și orice istoric public sunt furnizate „ca atare”, cu titlu informativ, și pot fi întârziate, incomplete, eronate sau indisponibile. Nu trebuie folosite ca singură bază pentru o decizie de investiție.",
      ],
    },
    {
      title: "12. Disponibilitate, mentenanță și suport",
      paragraphs: [
        "Serviciul este furnizat fără SLA, în lipsa unui acord scris separat. Pot apărea întreruperi pentru mentenanță, forță majoră, defectarea gazdei, API-uri de piață sau Piețe. AlgorithmNode depune eforturi rezonabile de restabilire, dar nu garantează continuitate 24/7.",
        "Suportul se face prin formularul de contact, în programul de lucru, fără termen de răspuns garantat.",
      ],
    },
    {
      title: "13. Răspundere",
      paragraphs: [
        "În limitele permise de lege, AlgorithmNode nu răspunde pentru prejudicii indirecte, pierderea unei șanse, profit nerealizat, pierdere de date, prejudiciu de imagine sau pierderi dintr-o decizie de investiție, slippage, execuție parțială, parametrizare greșită a Limitelor sau fapta unui terț.",
        "Răspunderea totală a AlgorithmNode, din orice cauză, este limitată, per eveniment și per an calendaristic, la cea mai mare valoare dintre (i) taxele de Serviciu efectiv plătite către AlgorithmNode în ultimele douăsprezece (12) luni și (ii) o sută (100) de euro, cu excepția dolului, a abaterii grave, a vătămării corporale și a drepturilor imperative ale consumatorului.",
        "Nimic nu exclude răspunderea care nu poate fi limitată legal.",
      ],
    },
    {
      title: "14. Despăgubire",
      paragraphs: [
        "Despăgubiți AlgorithmNode pentru orice pretenție a unui terț rezultând din folosirea ilicită, încălcarea Termenilor, informații false sau nerespectarea regulilor unei Piețe, inclusiv costuri rezonabile de apărare.",
      ],
    },
    {
      title: "15. Suspendare și încetare",
      paragraphs: [
        "Puteți înceta folosirea site-ului oricând. Închiderea Contului se cere prin contact, sub rezerva operațiunilor deschise, a conservării legale și a controalelor de conformitate.",
        "AlgorithmNode poate suspenda sau înceta accesul imediat, fără preaviz, pentru încălcare, risc de securitate, inactivitate prelungită, ordin al unei autorități sau dacă Serviciul este întrerupt. Clauzele destinate să supraviețuiască rămân în vigoare.",
      ],
    },
    {
      title: "16. Protecția datelor",
      paragraphs: [
        "Prelucrarea datelor personale este descrisă în Politica de confidențialitate, parte a relației contractuale. Folosind Serviciul, recunoașteți că ați luat cunoștință de ea.",
      ],
    },
    {
      title: "17. Forță majoră",
      paragraphs: [
        "AlgorithmNode nu răspunde pentru neexecutări cauzate de forță majoră, inclusiv pene generalizate de rețea, atacuri cibernetice de amploare, conflict, decizii ale autorităților de piață sau indisponibilitatea durabilă a unei Piețe ori a unui împuternicit critic.",
      ],
    },
    {
      title: "18. Drept aplicabil și litigii",
      paragraphs: [
        "Termenii sunt guvernati de dreptul francez, fără a aduce atingere normelor imperative ale Uniunii Europene și, dacă sunteți consumator, dispozițiilor mai protectoare ale statului de reședință obișnuită, atunci când se aplică.",
        "Litigiile se încearcă amiabil prin formularul de contact. În lipsă, și sub rezerva competențelor imperative, sunt competente instanțele franceze. Consumatorul poate apela la medierea consumului, când legea o permite, și la platforma europeană de soluționare online a litigiilor.",
      ],
    },
    {
      title: "19. Dispoziții generale",
      paragraphs: [
        "Dacă o clauză este nulă, celelalte rămân. Neinvocarea unei încălcări nu înseamnă renunțare. Nu puteți cesiona Termenii fără acord. AlgorithmNode poate cesiona contractul unui succesor în cadrul unei reorganizări, cu respectarea drepturilor persoanelor vizate.",
        "Limba de referință a documentelor juridice este franceza. Traducerile sunt pentru comoditate; în caz de divergență prevalează versiunea franceză, exceptând o obligație contrară a unui drept local imperativ.",
      ],
    },
  ],
};
...
export const termsByLocale: Record<Locale, LegalDoc> = { fr, en, es, it, de, ro };
